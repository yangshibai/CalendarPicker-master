...
public class CalendarLayout extends FrameLayout {
    ...
    //展开
    public  final int TYPE_OPEN = 0;
    //折叠
    public  final int TYPE_FOLD = 1;
    ...
    public interface onOpenFoldListener{
        void change(int type);
    }
    onOpenFoldListener listener;
    public void setOnOpenFoldListener(onOpenFoldListener listener) {
